...
Then, we were able to merge both of our exposures into one data set with the 
following variables:
...
#### Merged State Level Outcome Data (lc_mel_asthma_state)
...
#### Merged County Level Outcome Data (lc_mel_asthma_county)
...
In the name of exploration we created some bivariate plots to assess general 
trends in the relationships between **air pollution and lung cancer** and 
...
Generally, it appears that there is a negative correlation between lung cancer 
rates and year, ozone levels and year, and particulate matter and year. This 
indicates that as years increase, we may expect to see lung cancer age-adjusted 
rates per 100,000, median summer o3 levels (ppm), and particulate matter 2.5
(ug/m^3) all to decrease. 

Additionally, lung cancer is highly positively correlated with both ozone and
particulate matter, meaning that our exposure and outcome rates increase and 
decrease in the same direction. As particulate matter and ozone levels increase,
we expect lung cancer age-adjusted incidence rates per 100,000 to similarly 
increase.
...
For our melanoma plots, it appears that there is a positive correlation between 
melanoma rates and year while spring and summer EDD (J/m^2) rates and year are 
not significantly related. This indicates that as years increase, we may expect 
to see melanoma age-adjusted incidence rates per 100,000 to increase as well.
However, as years increase, we have no significant way of predicting how our 
exposures will change.


Additionally, melanoma is somewhat positively correlated with both spring and summer
EDD (J/m^2), meaning that our exposure and outcome rates increase and 
decrease in the same direction. As spring and summer EDD increase, we may see a
slightly associated increase in melanoma age adjusted incidence rates per 100,000.
...
From our correlations, we were able to learn even more about our data. We see that
lung cancer is negatively correlated with year while melanoma is positively correlated
with year. Generally, we can assume that we will expect to see lung cancer rates
to decrease while melanoma rates increase as years go on. The decline in lung cancer
incidence over time may be attributable to factors we cannot quantify in this map,
such as the decrease in tobacco-smoking rates across the United States and 
legislation that has prevented individuals from smoking in certain public spaces.
Further analysis may be warranted to understand fully how and why these have 
changed over time.

We can also see from our models that
...
looking at hospitalizations because publically available Pennsylvania data only 
