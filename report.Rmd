...
Code can be found on the [Climate Data](https://beeleeballin.github.io/p8105-final_project/merge-ap-uv.html) page
...
For both exposure/outcome pairings, we worked to understand their relationship
through regression models. 

After paring down our lung cancer model with BIC, we 
observed an R^2 value of **0.97**, which felt unreasonably high. After observing
diagnostic plots like Q-Q and Box-Cox, (viewable on the [Regression](https://beeleeballin.github.io/p8105-final_project/regression.html) page),
we found that the residuals were centered and relatively even with no extreme
outliers. When we cross-validated using leave-one-out and Monte-Carlo, our 
BIC fit was best, though we still suspect overfitting. Additionally, it is important
to acknowledge that this data set does not account for many of the relevant
predictors for lung cancer, including age, race, and, perhaps most importantly,
smoking.
