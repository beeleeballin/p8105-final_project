...
write_csv(extreme_value,"data/ap_uv/ext_value.csv")
write_csv(tidy_pm_df,"data/ap_uv/pm25.csv")
write_csv(tidy_oz_df,"data/ap_uv/o3.csv")
write_csv(tidy_uv_df,"data/ap_uv/edd.csv")
